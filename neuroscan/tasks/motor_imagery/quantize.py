...
class Quantize:
    ...
    def main(cls):
        ...
        Xc = Transforms.crops(Xte_std, crop_len, clf.n_test_crops)[0] if crop_len else Xte_std
        ...
        acc_fp32 = metrics.Metrics.accuracy(
            yte, cls._onnx_trial_proba(fp32_path, Xte_std, crop_len, clf.n_test_crops).argmax(1))
        ...
        try:
            ...
            rep["accuracy"]["onnx_int8"] = metrics.Metrics.accuracy(
                yte, cls._onnx_trial_proba(int8_path, Xte_std, crop_len, clf.n_test_crops).argmax(1))
        ...
        cls._track_run(rep, args.method, sub, gap, rep_dir)
        cls._report(rep, args.method, sub, gap, out)
