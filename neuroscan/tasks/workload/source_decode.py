...
class SourceDecode:
    ...
    def _build():
        ...
        for s in subs:
            ...
            c_sensor.append(SourceDecode._cov(x))
            c_source.append(SourceDecode._cov(Source.to_parcels(x, ch, _CFG.resample)))   # [n,68,t] cortical parcels
            ys.append(y)
...
def main():
    ...
    a_sen, s_sen = SourceDecode._decode(c_sensor, y, g)
    a_src, s_src = SourceDecode._decode(c_source, y, g)
