...
class InvariantCheckDict(TypedDict, total=False):
    """Result dict for invariant checks from evaluate/train."""
    single_trial: dict[int | str, float]
    single_trial_ci: dict[int | str, tuple[float, float, float]]
    chance_top1: float
...
class Invariants:
    ...
    @staticmethod
    def check(res: InvariantCheckDict, *, strict: bool = False) -> list[str]:
    ...
    @staticmethod
    def _brackets(res: InvariantCheckDict) -> list[str]:
    ...
    @staticmethod
    def _ci_matches_mean(res: InvariantCheckDict) -> list[str]:
    ...
    @staticmethod
    def _above_chance(res: InvariantCheckDict) -> list[str]:
