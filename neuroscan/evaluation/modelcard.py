...
from neuroscan.evaluation.harness import AggregateResult


class ModelCard:
    @staticmethod
    def card(res: AggregateResult, dataset: str, regime: str) -> str:
    ...
    @staticmethod
    def write(res: AggregateResult, dataset: str, regime: str, path: str | Path) -> Path:
        path = Path(path)
